---
title: "KFunc 'bpf_mem_cgroup_memory_events'"
description: "This page documents the 'bpf_mem_cgroup_memory_events' eBPF kfunc, including its definition, usage, program types that can use it, and examples."
---
# KFunc `bpf_mem_cgroup_memory_events`

<!-- [FEATURE_TAG](bpf_mem_cgroup_memory_events) -->
[:octicons-tag-24: v7.0](https://github.com/torvalds/linux/commit/99430ab8b804c26b8a0dec93fcbfe75469f3edc7)
<!-- [/FEATURE_TAG] -->

Read memory cGroup's memory event value.
...
The current value of the memory event counter.

**Signature**

<!-- [KFUNC_DEF] -->
`#!c long unsigned int bpf_mem_cgroup_memory_events(struct mem_cgroup *memcg, memcg_memory_event event)`
<!-- [/KFUNC_DEF] -->
