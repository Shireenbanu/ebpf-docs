---
title: "KFunc 'scx_bpf_cid_curr'"
description: "This page documents the 'scx_bpf_cid_curr' eBPF kfunc, including its definition, usage, program types that can use it, and examples."
---
# KFunc `scx_bpf_cid_curr`

<!-- [FEATURE_TAG](scx_bpf_cid_curr) -->
...
cid-addressed equivalent of [`scx_bpf_cpu_curr`](scx_bpf_cpu_curr.md). Callers must hold RCU read lock ([`KF_RCU`](../concepts/kfuncs.md#kf_rcu)). 
...
<!-- [KFUNC_DEF] -->
`#!c struct task_struct *scx_bpf_cid_curr(s32 cid)`
