---
title: "KFunc 'bpf_put_mem_cgroup'"
description: "This page documents the 'bpf_put_mem_cgroup' eBPF kfunc, including its definition, usage, program types that can use it, and examples."
---
# KFunc `bpf_put_mem_cgroup`

<!-- [FEATURE_TAG](bpf_put_mem_cgroup) -->
...
Implements [`KF_RELEASE`](../concepts/kfuncs.md#kf_release) semantics.
...
<!-- [KFUNC_DEF] -->
`#!c void bpf_put_mem_cgroup(struct mem_cgroup *memcg)`
