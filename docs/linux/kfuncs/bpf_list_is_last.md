---
title: "KFunc 'bpf_list_is_last'"
description: "This page documents the 'bpf_list_is_last' eBPF kfunc, including its definition, usage, program types that can use it, and examples."
---
# KFunc `bpf_list_is_last`

<!-- [FEATURE_TAG](bpf_list_is_last) -->
...
<!-- [KFUNC_DEF] -->
`#!c bool bpf_list_is_last(struct bpf_list_head *head, struct bpf_list_node *node__nonown_allowed)`
<!-- [/KFUNC_DEF] -->
