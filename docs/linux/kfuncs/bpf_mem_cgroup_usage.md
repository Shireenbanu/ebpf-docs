---
title: "KFunc 'bpf_mem_cgroup_usage'"
description: "This page documents the 'bpf_mem_cgroup_usage' eBPF kfunc, including its definition, usage, program types that can use it, and examples."
---
# KFunc `bpf_mem_cgroup_usage`

<!-- [FEATURE_TAG](bpf_mem_cgroup_usage) -->
...
<!-- [KFUNC_DEF] -->
`#!c long unsigned int bpf_mem_cgroup_usage(struct mem_cgroup *memcg)`
<!-- [/KFUNC_DEF] -->
